...
Original file is located at
    https://colab.research.google.com/drive/1CmL_En92_FAg7jipTdvvnEEQYRWSIrjW
"""

model = Sequential()
# Embedding layer
model.add(Embedding(input_dim=max_len,output_dim = 256, trainable=False, mask_zero=True))
# Masking layer for pre-trained embeddings
#model.add(Masking(mask_value=0.0))
# Recurrent layer
model.add(LSTM(265,return_sequences=False, dropout=0.1))
